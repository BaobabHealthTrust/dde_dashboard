...
class Npid < CouchRest::Model::Base
  ...
  design do
    ...
    view :pending,
         :map => "                function(doc) {\n                  if (doc.type == 'RequestsQue' && doc['site_code'] != null && doc.region != null){\n                  \temit([doc.site_code, doc.request_processed], 1);\n            \t  }\n                }\n",
         :reduce => "_sum"

    view :pending_by_date,
         :map => "                function(doc) {\n                  if (doc.type == 'RequestsQue' && doc['site_code'] != null && doc.region != null && doc.request_processed == false){\n                  \temit((new Date(doc.date_created)).getTime(), 1);\n            \t  }\n                }\n"
